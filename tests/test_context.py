...
from table1_parser.context.visual_references import collect_paper_visual_references
from table1_parser.schemas import ColumnDefinition, DefinedColumn, DefinedVariable, PaperVisual, TableDefinition
...
def test_build_table_context_collects_table_mentions_and_term_matches() -> None:
    ...
    visuals = [
        PaperVisual(
            visual_id="paper_visual:table:2",
            visual_kind="table",
            label="Table 2",
            number="2",
    ...
    context = build_table_context(0, definition, sections, visuals, references)
